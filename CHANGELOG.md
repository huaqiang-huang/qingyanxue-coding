...
All notable changes to the 清砚雪Coding AI agent desktop app will be documented in this file.
...
- Updated 清砚雪Coding app icons for Windows and macOS packaging (branding refresh)
...
- Initial release of 清砚雪Coding — open-source AI agent desktop app with one-click install for Windows and macOS

[Unreleased]: https://github.com/huaqiang-huang/qingyanxue-coding/compare/v3.3.0-beta.8...HEAD
[3.3.0-beta.8]: https://github.com/huaqiang-huang/qingyanxue-coding/compare/v3.2.0...v3.3.0-beta.8
[3.2.0]: https://github.com/huaqiang-huang/qingyanxue-coding/compare/v3.1.0...v3.2.0
[3.1.0]: https://github.com/huaqiang-huang/qingyanxue-coding/compare/v3.0.0...v3.1.0
[3.0.0]: https://github.com/huaqiang-huang/qingyanxue-coding/compare/v2.0.0...v3.0.0
[2.0.0]: https://github.com/huaqiang-huang/qingyanxue-coding/compare/v1.0...v2.0.0
[1.0.0]: https://github.com/huaqiang-huang/qingyanxue-coding/releases/tag/v1.0
